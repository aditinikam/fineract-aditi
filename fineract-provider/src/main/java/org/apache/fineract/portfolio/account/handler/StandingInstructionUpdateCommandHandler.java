...
public class StandingInstructionUpdateCommandHandler
        implements CommandHandler<StandingInstructionUpdatesRequest, StandingInstructionUpdateResponse> {
    ...
    @Override
    @Transactional
    public StandingInstructionUpdateResponse handle(Command<StandingInstructionUpdatesRequest> command) {
        return writeService.update(command.getPayload());
    }

    @Override
    public StandingInstructionUpdateResponse fallback(Command<StandingInstructionUpdatesRequest> command, Throwable t) {
